...
import dev.adryanev.dicodingstory.features.story.presentation.story_list.pages.placeholder.PlaceholderContent
    ...
    override fun onCreateView(
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = StoryListRecyclerViewAdapter(PlaceholderContent.ITEMS)
            }
        }
        return view
    }
